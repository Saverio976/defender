...
int object_add_hover_event(object_t *object, void (*hover)(object_t *, void *,
    window_t *win))
{
    on_hover_t *on_hover = malloc(sizeof(on_hover_t));
    ...
    return object_add_components(object, on_hover, "__on_hover", &free);
}

int object_add_right_click_event(object_t *object, void (*right_click)(object_t *,
    void *, window_t *win))
{
    on_right_click_t *on_right = malloc(sizeof(on_right_click_t));
    ...
    return object_add_components(object, on_right, "__on_right_click", &free);
}

int object_add_right_click_event(object_t *object, void (*left_click)(object_t *,
    void *, window_t *win))
{
    on_left_click_t *on_left = malloc(sizeof(on_left_click_t));
    ...
    return object_add_components(object, on_left, "__on_left_click", &free);
}
